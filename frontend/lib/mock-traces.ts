import agentTelemetry from "../data/agent_telemetry.json";
import cohortSummary from "../data/cohort_summary.json";
import diagnosisReport from "../data/diagnosis_report_complete.json";
import remediationPlan from "../data/remediation_plan.json";
